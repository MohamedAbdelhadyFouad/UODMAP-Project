...
//Dependencies used @ABDULQADIR, @MOHAMMED
...
// CONNECTION TO MYSQL DATABASE @MOHAMMED
...
//declare express app @ABDULQADIR
var app = express();

//set path for html template engine (views) @ABDULQADIR, @MOHAMMED, @ANASTASIIA, @ALIIA
nunjucks.configure('views', {
  autoescape: true,
  express   : app
});

//Define middlewares @ABDULQADIR
...
//send LOGIN page to the client, this is the default page of uod map @ABDULQADIR
app.get('/', function(request, response) {
	response.render('index.html');
});

//send back the user data to the server to process  @ABDULQADIR, @MOHAMMED
...
//send register page to the client @ABDULQADIR
...
//send home page to the client @ABDULQADIR
...
//send profile page to the client @ABDULQADIR, @MOHAMMED
...
//when client logs out, display login page @ABDULQADIR
